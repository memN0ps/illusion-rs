...
/// The entry point for the hypervisor.
///
/// This function is the main entry point for the hypervisor and is called by the bootloader.
///
/// # Arguments
///
