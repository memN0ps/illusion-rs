...
impl HookManager {
    ...
    pub fn new() -> Result<Box<Self>, HypervisorError> {
        log::trace!("Initializing hook manager");
        ...
        for _ in 0..MAX_HOOKS {
            ...
            let ept_hook =
                EptHook::new(host_shadow_page, primary_ept_pre_alloc_pt, trampoline_page);
    ...
    pub fn find_hook_by_guest_va(&mut self, guest_va: u64) -> Option<&mut EptHook> {
